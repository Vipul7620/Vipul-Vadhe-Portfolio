...
const designWorks = [
  {
    title: 'Bhumi Pure',
    coverImage: '/Bhumi Pure/BhoomiPure logo file-01.png',
    hint: 'bhumi pure design',
    images: [
      { src: '/Bhumi Pure/BhoomiPure logo file-01.png', hint: 'bhumi pure logo' },
      { src: '/Bhumi Pure/BhumiPure Visiting Card Front.png', hint: 'bhumi pure visiting card front' },
      { src: '/Bhumi Pure/BhumiPure Visiting Card Back.png', hint: 'bhumi pure visiting card back' }
    ],
    pdf: '/Bhumi Pure/BhoomiPure BRANDING KIT.pdf'
  },
  {
    title: 'Bubble Bliss',
    coverImage: '/Bubble Bliss/Bubble Bliss Logo.png',
    hint: 'bubble bliss design',
    images: [
      { src: '/Bubble Bliss/BOBA.jpg', hint: 'bubble bliss boba' },
      { src: '/Bubble Bliss/bubble bliss.png', hint: 'bubble bliss main' },
      { src: '/Bubble Bliss/coffee.jpg', hint: 'bubble bliss coffee' },
      { src: '/Bubble Bliss/Cold Coffee.jpg', hint: 'bubble bliss cold coffee' },
      { src: '/Bubble Bliss/Strawberry.jpg', hint: 'bubble bliss strawberry' }
    ],
    pdf: '/Bubble Bliss/Bubble Bliss Branding Kit.pdf'
  },
  {
    title: 'Cake Shop',
    coverImage: '/Cake Shop/2nd Slide.png',
    hint: 'cake shop design',
    images: [
      { src: '/Cake Shop/2nd Slide.png', hint: 'cake shop slide 2' },
      { src: '/Cake Shop/3rd Slide.png', hint: 'cake shop slide 3' },
      { src: '/Cake Shop/4th Slide.png', hint: 'cake shop slide 4' }
    ],
    video: '/Cake Shop/1st Slide.mp4'
  },
  {
    title: 'CARS',
    coverImage: '/CARS/amg 63.jpg',
    hint: 'car design',
    images: [
      { src: '/CARS/amg 63.jpg', hint: 'amg 63' },
      { src: '/CARS/g63.jpg', hint: 'g63' },
      { src: '/CARS/Supra.jpg', hint: 'supra' },
      { src: '/CARS/THAR.jpg', hint: 'thar' }
    ]
  },
  {
    title: 'Shoes',
    coverImage: '/Shoes/Adidas Superstar.jpg',
    hint: 'shoes design',
    images: [
      { src: '/Shoes/Adidas Superstar.jpg', hint: 'adidas superstar' },
      { src: '/Shoes/AIR 1 Chicago.jpg', hint: 'air 1 chicago' }
    ]
  },
  {
    title: 'Tee Fusion',
    coverImage: '/Tee Fusion/PAGE 1.png',
    hint: 'tee fusion design',
    images: [
      { src: '/Tee Fusion/PAGE 1.png', hint: 'tee fusion page 1' },
      { src: '/Tee Fusion/PAGE 3.png', hint: 'tee fusion page 3' },
      { src: '/Tee Fusion/PAGE 4.png', hint: 'tee fusion page 4' },
      { src: '/Tee Fusion/PAGE 5.png', hint: 'tee fusion page 5' },
      { src: '/Tee Fusion/PAGE 6.png', hint: 'tee fusion page 6' },
      { src: '/Tee Fusion/FACEBOOK AD.png', hint: 'tee fusion facebook ad' },
      { src: '/Tee Fusion/extra.png', hint: 'tee fusion extra' }
    ]
  },
            ...
            <div className="container mx-auto px-4">
                ...
                <Tabs defaultValue="designer" className="w-full">
                  <TabsList className="flex justify-center gap-4 mb-8">
                    <TabsTrigger value="designer">Design Works</TabsTrigger>
                    <TabsTrigger value="developer">Development Projects</TabsTrigger>
                  </TabsList>
